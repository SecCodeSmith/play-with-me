"""
Django settings for play_with_me project.
...
from play_with_me.custem_lookup import Like

load_dotenv('config.properties')

CharField.register_lookup(Like)
...
SECRET_KEY = 'django-insecure-42g^qn_5svgb@ih52gq&&3_^9#u6)4qii0foi^!2dpgu3xx6n+'
...
ROOT_URLCONF = 'play_with_me.urls'
...
WSGI_APPLICATION = 'play_with_me.wsgi.application'
